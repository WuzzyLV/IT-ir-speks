                ...
                <div class="pb-12">
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 m-4">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea type="text" name="desc" id="desc" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-accent1 sm:text-sm sm:leading-6 bg-white pl-4 h-40"></textarea>
                            </div>
                        </div>

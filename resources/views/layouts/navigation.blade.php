...
<nav x-data="{ open: false }" class="border-b border-gray-100 bg-dark1 shadow-md">
        ...
        <div class="flex h-16 justify-between sm:mx-6">
            ...
            <div class="hidden sm:ms-6 sm:flex sm:items-center">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="bg-b inline-flex items-center rounded-md border border-transparent px-1 py-2 text-sm font-medium leading-4 text-light1 transition duration-150 ease-in-out hover:bg-accent1 hover:text-dark1 focus:outline-none">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route("logout") }}">
                            ...
                            <x-dropdown-link :href="route('logout')" class="!text-red-400" onclick="event.preventDefault();
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="self-end border-t border-light1 pb-1 pt-4 text-light1 shadow-lg shadow-light1">
            <div class="px-4">

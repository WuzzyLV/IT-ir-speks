<x-app-layout class="h-screen " navAbsolute="true">
    <!-- prettier-ignore -->
    <div class="relative isolate overflow-hidden bg-gray-900 pt-32 sm:pt-40 h-screen flex flex-col">
...
{{--        </div>--}}
        ...
        <div class="mx-4 sm:mx-1 mt-14 max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">IT ir spēks</h2>
